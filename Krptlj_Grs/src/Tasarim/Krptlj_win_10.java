...
public class Krptlj_win_10 {
	...
	private void initialize() {
		frame = new JFrame("XOR ÝLE ÞÝFRELEME");
		frame.setVisible(true);
		frame.setBounds(100, 100, 635, 395);
		//frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		Image img = new ImageIcon(this.getClass().getResource("/bin_xor.jpg")).getImage();
		Image img2 = new ImageIcon(this.getClass().getResource("/xor.png")).getImage();
		...
		JButton btn_asci = new JButton("XOR Ýþlemini Gerçekleþtir");
	...
	private void setContentPane(JScrollBar scrollBar) {
